...
namespace CSInteroperabilityConsole
{
    ...
    public class TallyWorldException : Exception
    {
        ...
        public TallyWorldException(string message)
            : base(message)
        { }
        ...
        public TallyWorldException(string message, Exception innerException)
        ...
        public TallyWorldException(string format, params object[] args)
        ...
        protected TallyWorldException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        { }

        internal TallyWorldException(string message, TWErrorCode code, TWErrorCategory category) : this(message)
        {
            Data.Add("tw.code", (int)code);
            Data.Add("tw.category", (int)category);
        }
