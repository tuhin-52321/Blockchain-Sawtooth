...
namespace Sawtooth.Sdk.Net.Transactions
{
    ...
    public class SmallbankTransaction : ProtobufPayload<SmallbankTransactionPayload>, ITransaction
    {
        ...
        protected SmallbankTransaction() : base()
        {
        }
        public string DisplayString
        {
        ...
        public static SmallbankTransaction CreateDepositCheckTransaction(uint? cutomerId, uint amount)
        {
        ...
        public static SmallbankTransaction CreateDepositCashTransaction(uint? cutomerId, int amount)
        {
            return new SmallbankTransaction { Payload = SmallbankTransactionPayload.CreateDepositCashTransactionPayload(cutomerId, amount) };
        }

        public static SmallbankTransaction CreateSendPaymentTransaction(uint? cutomerId, uint destCustomerId, uint amount)
        {
